...
namespace VdbCappucino {
	...
	class SOP_VdbProjectVector : public openvdb_houdini::SOP_NodeVDB
	{
	public:
	...
	protected:
		...
		SOP_VdbProjectVector(OP_Network *net, const char *name, OP_Operator *op);

		virtual ~SOP_VdbProjectVector();
